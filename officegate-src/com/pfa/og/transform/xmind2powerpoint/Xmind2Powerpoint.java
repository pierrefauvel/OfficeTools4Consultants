package com.pfa.og.transform.xmind2powerpoint;
...
import com.pfa.og.to.powerpoint2007.Outline2Powerpoint2007;
import com.pfa.og.to.word.OfficeGateHtml4WordGenerator;

public class Xmind2Powerpoint {
		...
		public static String[] generateDocs(File f) throws XPathExpressionException, ZipException, IOException, ParserConfigurationException, SAXException, TransformerException
		{
			...
			String suffix = f.getName()+"."+shi.getLabel()+"."+shi.getChildren()[0].getLabel()+".ppt";
			...
			Outline2Powerpoint2007.convert(o, f1, f.getCanonicalPath()+" "+new SimpleDateFormat().format(new Date()));
